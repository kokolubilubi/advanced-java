...
public class UserDaoImplTest {
	...
	public void testFindAndUpdate() throws SQLException {
		...
		assertEquals("retrieved user does not match saved user",user,retrievedUser);
		
		user.setName("xvcasdf");
		...
		assertEquals("retrieved user does not match updated user",user,retrievedUser);
	...
	public void testSaveMultiple() throws SQLException {
		...
		assertEquals("retrieved users do not match saved users", users,retrievedUsers );
	...
	public void testGetAll() throws SQLException {
		...
		assertEquals("retrieved users do not match saved users", users,dbUsers );
